...
| K05 | Audit skipPaths 精确匹配 | v1.2.0 审查 | 审计日志详情页仍会记日志 | ✅ 已修复 (a235b95) |
| K06 | settings_handler 忽略 error | v1.2.0 审查 | 忽略 DB error 存在数据丢失风险 | ✅ 已修复 (v1.2.0 P1-12) |
| K07 | 审计日志状态标注矛盾 | v1.2.0 审查 | features/README 与 CHANGELOG 不一致 | ✅ 已修复 (a235b95) |
| K08 | 无升级指南 | v1.2.0 审查 | 从旧版本升级缺少步骤文档 | ✅ 已修复 (a235b95) |
| K09 | 无发布检查清单 | v1.2.0 审查 | 发布流程缺少可执行 checklist | ✅ 已修复 (a235b95) |
| K10 | 无回滚策略文档 | v1.2.0 审查 | git-workflow 缺少回滚章节 | ✅ 已修复 (a235b95) |
| K13 | 模型定价 ability_types 类型不匹配 | 用户测试 | 前端 `el-input` 以字符串发送，后端期望数组 | ✅ 已修复 (#011) |
